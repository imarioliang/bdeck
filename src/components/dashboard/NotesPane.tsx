      ...
      <div className="flex flex-1 overflow-hidden min-h-[300px]">
        ...
        <div className="flex-1 relative group">
          <textarea 
            ...
            className="w-full h-full bg-transparent focus:outline-none p-4 pt-4 text-[11px] font-medium leading-6 resize-none custom-scrollbar text-white/60 selection:bg-terminal-main selection:text-black font-mono tracking-wide"
          ...
          {/* CURSOR EFFECT */}
          <div className="absolute bottom-4 right-4 w-2 h-4 bg-terminal-main opacity-30 animate-pulse pointer-events-none shadow-[0_0_5px_rgba(255,157,0,0.5)]"></div>
        </div>
      </div>
    </div>
  );
