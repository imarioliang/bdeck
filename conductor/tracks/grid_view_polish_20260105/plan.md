...
## Phase 1: Inversion & Overlay Layout [checkpoint: f9f77d8]
*Goal: Implement the "Full Card Inversion" effect and the "Center Overlay" container for actions.*

- [x] **Task 1: Refactor SortableLinkItem Hover State** [f9f77d8]
...
## Phase 2: Action Button Refinement [checkpoint: f9f77d8]
*Goal: Implement and style the minimalist symbols for managing links.*

- [x] **Task 1: Implement Minimalist Symbols** [f9f77d8]
